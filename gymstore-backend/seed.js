...
const products = [
  ...
  { 
    ...
    price: 200, 
    category: 'equipment', 
    image: '/images/band.avif', // local path
  ...
  { 
    ...
    price: 300, 
    category: 'equipment', 
    image: '/images/threadmill.jpg', // local path
  ...
  { 
    ...
    price: 100, 
    category: 'equipment', 
    image: '/images/bike.png', // local path
  ...
  { 
    ...
    price: 200, 
    category: 'equipment', 
    image: '/images/ball.avif', // local path
  ...
  { 
    ...
    price: 300, 
    category: 'equipment', 
    image: '/images/bar.png', // local path
  ...
  { 
    ...
    image: '/images/mat.jpg', // local path
  ...
  { 
    ...
    price: 200, 
    category: 'equipment', 
    image: '/images/rope.webp', // local path
  ...
  { 
    ...
    price: 300, 
    category: 'supplement', 
    image: '/images/whey.png', // local path
  ...
  { 
    ...
    price: 100, 
    category: 'supplement', 
    image: '/images/creagen.png', // local path
  ...
  { 
    ...
    price: 200, 
    category: 'supplement', 
    image: '/images/pre.png', // local path
  ...
  { 
    ...
    price: 300, 
    category: 'supplement', 
    image: '/images/glutamine.webp', // local path
